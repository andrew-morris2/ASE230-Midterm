        ...
        <header class="bg-dark py-5">
            <div class="container px-4 px-lg-5 my-5">
                <div class="text-center text-white">
                    ...
                    <p class="lead fw-normal text-white-50 mb-0">As an admin you can edit, delete, and add products. More features coming soon!</p>
                </div>
            </div>
        </header>
        <!-- Section-->
        <section class="py-5">
        <h1 class="text-center text-black">All products </h1>
